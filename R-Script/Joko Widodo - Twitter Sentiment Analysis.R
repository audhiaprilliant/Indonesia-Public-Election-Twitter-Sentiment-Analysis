# ===== TWITTER DATA ANALYSIS WITH PACKAGE twitteR - JOKO WIDODO =====
# References:
...
data.jokowi = searchTwitter(searchString = 'Joko Widodo',
                            n = 1000,
                            lang = 'id')
# ===== CONVERT DATA TO DATA FRAME
data.jokowi.df = twListToDF(data.jokowi)
View(data.jokowi.df)

# ===== SAVE DATA
write.csv(x = data.jokowi.df,
          file = 'D:/Audhi Aprilliant/IPB Works/Statistics Department/Data Science Practices/Projects/Indonesia Public Election - Twitter Sentiment Analysis/Datasets/Data Joko Widodo.csv',
          row.names = FALSE)
...
# ===== DATA CLEANSING
# Work with Corpus
tweet.corpus = VCorpus(VectorSource(data.jokowi.df$text))
...
# ===== SAVE DATA RESULTS
write.csv(x = results,
          file = 'D:/Audhi Aprilliant/IPB Works/Statistics Department/Data Science Practices/Projects/Indonesia Public Election - Twitter Sentiment Analysis/Datasets/Sentiment Data Joko Widodo.csv',
          row.names = FALSE)
