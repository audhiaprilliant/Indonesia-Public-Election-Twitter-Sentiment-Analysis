...
# ===== LOAD THE RAW DATA
data.raw = read.csv('D:/Audhi Aprilliant/IPB Works/Statistics Department/Data Science Practices/Projects/Indonesia Public Election - Twitter Sentiment Analysis/Datasets/Data Joko Widodo.csv',
                    header = TRUE,
                    sep = ',')
data.raw.label = read.csv('D:/Audhi Aprilliant/IPB Works/Statistics Department/Data Science Practices/Projects/Indonesia Public Election - Twitter Sentiment Analysis/Datasets/Sentiment Data Joko Widodo.csv',
                          header = TRUE,
                          sep = ',')
...
data.corpus = read.csv('D:/Audhi Aprilliant/IPB Works/Statistics Department/Data Science Practices/Projects/Indonesia Public Election - Twitter Sentiment Analysis/Datasets/Sentiment Data Joko Widodo.csv',
                       header = TRUE,
                       sep = ',')
...
# MAKING PREDICTION
valid_pred = predict(nb.model, data.test)
#STORING MODEL PERFORMANCE SCORES
confusionMatrix(valid_pred, data.raw.test$class, positive = 'Positive')